...
import { deleteLesson } from "../actions/edit-course";
     ...
     <AlertDialog open={open} onOpenChange={setOpen}>
        ...
        <AlertDialogContent>
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>This action cannot be undone. Confirm to delete lesson permanently!</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
