  ...
  return (
    <section className="relative w-full min-h-[70vh] bg-background text-foreground overflow-hidden font-sans">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 pt-24 pb-12 text-center">
       ...
       <h1 className="text-5xl md:text-6xl font-bold tracking-tight leading-[0.95] dark:text-[#a1a1a1] text-black">
          Turn What You Know 
          <span className="italic font-serif font-light dark:text-white text-blue-500 mr-4"> Into <br/></span> 
