...
import { deleteChapter } from "../actions/edit-course";
     ...
     <AlertDialog open={open} onOpenChange={setOpen}>
        ...
        <AlertDialogContent>
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>This action cannot be undone. Confirm to delete chapter permanently!</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
