...
import { PublicCourseType } from "@/app/actions/get-all-courses";
        ...
        <Card className="group relative py-0 gap-0">
            ...
            {thumbnailUrl && (
              ...
              <CardContent className="p-4">
                <Link
                  className="font-medium text-lg line-clamp-2 hover:underline group-hover:text-primary transition-colors" href={`/courses/${data.slug}`}>
                    {data.title}
                </Link>
